    ...
    <section className="py-24 bg-[#006838] dark:bg-black relative overflow-hidden text-center text-white">
       ...
       <div className="container mx-auto px-4 md:px-6 relative z-10">
          <motion.span 
            ...
            className="text-[#CC0000] font-mono text-xs font-bold uppercase tracking-widest mb-6 block animate-pulse"
          >
            Game On
          </motion.span>
          <motion.h2 
          ...
          >
             Book Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#CC0000] to-orange-500">Lane Today</span>
          </motion.h2>
