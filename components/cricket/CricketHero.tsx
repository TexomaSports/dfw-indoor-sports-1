...
const CricketHero: React.FC = () => {
  return (
    <div className="relative h-[50vh] min-h-[400px] flex items-center bg-[#006838] overflow-hidden group">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20 pt-20">
         ...
         <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-green-400/30 bg-green-900/40 backdrop-blur-xl text-green-100 font-mono text-[10px] uppercase tracking-[0.25em] mb-8 animate-fade-in-up hover:bg-green-900/60 transition-colors cursor-default shadow-[0_0_20px_rgba(22,163,74,0.2)]">
         ...
         <div className="flex flex-col md:flex-row items-start gap-8 mb-10 animate-slide-up" style={{ animationDelay: '0.1s' }}>
            <p className="max-w-xl text-gray-200 text-lg md:text-xl font-light leading-relaxed border-l-2 border-[#CC0000] pl-6 backdrop-blur-sm">
         ...
         <div className="flex flex-col sm:flex-row gap-4 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            <button className="group relative px-8 py-4 bg-[#CC0000] text-white font-bold uppercase tracking-widest text-xs rounded-sm overflow-hidden shadow-[0_0_40px_rgba(204,0,0,0.4)] transition-all hover:shadow-[0_0_60px_rgba(204,0,0,0.6)] hover:-translate-y-1">
            ...
            <button 
               ...
               className="px-8 py-4 bg-white text-[#006838] font-bold uppercase tracking-widest text-xs rounded-sm hover:bg-gray-100 transition-all shadow-lg flex items-center gap-2"
            >
               <PlayCircle size={14} /> View Facilities
            </button>
            <button 
               onClick={() => document.getElementById('pricing')?.scrollIntoView({ behavior: 'smooth' })}
               className="px-8 py-4 border border-white/20 bg-white/5 backdrop-blur-md text-white font-bold uppercase tracking-widest text-xs rounded-sm hover:bg-white hover:text-[#006838] transition-all flex items-center gap-2"
            >
         ...
         <div className="mt-16 pt-8 border-t border-white/10 flex flex-wrap gap-x-8 gap-y-4 text-xs font-mono font-bold text-green-100/70 uppercase tracking-widest animate-slide-up" style={{ animationDelay: '0.3s' }}>
            <span className="flex items-center gap-2"><Check size={14} className="text-[#CC0000]" /> Bowling Machines Free</span>
            <span className="flex items-center gap-2"><Check size={14} className="text-[#CC0000]" /> 72°F Climate Control</span>
            <span className="flex items-center gap-2"><Check size={14} className="text-[#CC0000]" /> Video Analysis</span>
            <span className="flex items-center gap-2"><Check size={14} className="text-[#CC0000]" /> 6 Pro Lanes</span>
         </div>
      </div>
    </div>
  );
