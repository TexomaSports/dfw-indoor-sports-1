       ...
       <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
             ...
             <div className="md:w-1/2 h-64 bg-gray-200 rounded-lg relative overflow-hidden shadow-inner flex items-center justify-center group">
                ...
                <MapPin size={48} className="text-[#006838] relative z-10 drop-shadow-xl" />
                <span className="absolute bottom-4 left-4 bg-white px-3 py-1 text-xs font-bold text-[#006838] rounded shadow-sm z-10">16230 Three Wide Dr</span>
             </div>
          </div>
       </div>
    </section>
