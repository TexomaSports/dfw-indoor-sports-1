        ...
        <div className="grid grid-cols-1 md:grid-cols-4 auto-rows-[280px] md:auto-rows-[320px] gap-4 md:gap-6">
          {facilities.map((item, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/graphy.png')] opacity-0 group-hover:opacity-10 transition-opacity duration-500 mix-blend-overlay"></div>
