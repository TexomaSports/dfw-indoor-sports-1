    ...
    <section className="py-24 bg-[#4C1D95] dark:bg-black relative overflow-hidden text-center text-white">
       ...
       <div className="container mx-auto px-4 md:px-6 relative z-10">
          <motion.span 
            ...
            className="text-orange-400 font-mono text-xs font-bold uppercase tracking-widest mb-6 block animate-pulse"
          >
            Get Moving
          </motion.span>
          <motion.h2 
          ...
          >
             Book Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-fuchsia-500">Court Today</span>
          </motion.h2>
          ...
          >
             <button className="px-10 py-5 bg-orange-600 text-white font-bold uppercase tracking-widest text-sm rounded-sm hover:bg-orange-700 transition-colors shadow-lg">
                Book Court Now
             </button>
             <button className="px-10 py-5 border border-white/20 text-white font-bold uppercase tracking-widest text-sm rounded-sm hover:bg-white hover:text-[#4C1D95] transition-colors flex items-center justify-center gap-2">
